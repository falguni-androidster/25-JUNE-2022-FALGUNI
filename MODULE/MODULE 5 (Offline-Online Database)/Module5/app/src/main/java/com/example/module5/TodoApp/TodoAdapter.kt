...
class TodoAdapter(var context: Context, var userlist: MutableList<TodoModel>, var tvnothing: TextView): RecyclerView.Adapter<TodoAdapter.DataClass>() {

    var isEnable = false
    var isSelectAll = false
    var selectList: ArrayList<TodoModel> = ArrayList()
                        ...
                        when (item.itemId) {
                            R.id.menu_delete -> {
                                for (s in selectList) {
                                    ...
                                    val myModel = TodoModel(viewholder.user_id, viewholder.user_task, viewholder.user_date, viewholder.user_time, viewholder.repeat,viewholder.user_list)
    ...
    private fun ClickItem(holder: DataClass) {
        val s: TodoModel = userlist.get(holder.adapterPosition)
        // check condition
